...
$conf = '../Config/';
	if (is_writable($conf)) {
	    $config = 'Your Config directory is writable <i class="fa fa-check"></i>';
	    $confmsg=true;
	} else {
	    $config = '<span style="color:red;">Your Config directory is not writable <i class="fa fa-times"></i></span>';
	    $confmsg=false;
	}
$tmp = '../tmp/';
	if (is_writable($conf)) {
	    $tmp = 'Your tmp directory is writable <i class="fa fa-check"></i>';
	    $tmpmsg = true;
	} else {
	    $tmp = '<span style="color:red;">Your tmp directory is not writable <i class="fa fa-times"></i></span>';
	    $tmpmsg = false;
	}
?>
<!DOCTYPE html>
