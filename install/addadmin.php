...
<p>First user is administrator on the system. Administrator have root/full access on the system.</p>
<form role="form" action="install.php" id="submit">
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input class="form-control" placeholder="John Doe" name="fname">
  </div>
   <div class="form-group">
