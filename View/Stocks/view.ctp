	...
	<div class="panel-body">
		<table class="table table-striped table-bordered table-hover" cellspacing="0">
			<tbody>
				...
				<tr class="<?php if($stock['Stock']['stock_status'] == 'Item out of stock'):echo 'danger';elseif($stock['Stock']['stock_status'] == 'Reached minimum quantity. Item need to restock'):echo 'warning';endif;?>"><th><?php echo __('Stock status');?></th><td><?php echo h($stock['Stock']['stock_status']); ?>&nbsp;</td></tr>
